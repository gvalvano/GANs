...
# data_path = "/home/gabriele/venvs/conda/miniconda3/envs/tf-gpu/lib/python3.8/site-packages/tensorflow_addons/" \
#             "custom_ops/image/_image_ops.so"
# _image_ops_so = tf.load_op_library(data_path)
